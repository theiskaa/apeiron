...
connections:
  ...
  - target: "hard-problem"
    reason: "Psychedelics radically change subjective experience while reducing brain activity, which makes the hard problem of why experience exists even harder to answer"
  - target: "panpsychism"
    reason: "People on psychedelics often report experiencing a universal consciousness present in everything, which is basically what panpsychism argues philosophically"
  - target: "secret-societies"
    reason: "Many secret societies, from the Eleusinian Mysteries to the Rosicrucians, used rituals and substances to deliberately induce altered states as part of their core practices"
  - target: "hermetic-tradition"
    reason: "Hermetic practices like alchemy, ritual magic, and the pursuit of gnosis were all methods for deliberately changing consciousness"
  - target: "mkultra"
  ...
  - target: "jung"
    reason: "Carl Jung's technique of 'active imagination' — entering a controlled waking trance, allowing autonomous figures to emerge from the unconscious, and engaging them in dialogue as if they were independent beings — is one of the most rigorous Western methods for the deliberate induction of altered states of consciousness. The Red Book, Jung's private record of his own active imagination work between 1913 and 1930, is one of the most extraordinary documents of self-induced visionary experience produced in the modern era. Jung treated the figures he encountered during these states — Philemon, Salome, Elijah, the dead — not as projections of his own mind but as autonomous psychic entities whose reality had to be reckoned with on its own terms. The active imagination tradition is the bridge between the older esoteric methods for inducing altered states (the alchemical, hermetic, and shamanic traditions) and the modern psychological and psychedelic frameworks. Without Jung, the altered-states discussion has no twentieth-century clinical anchor that takes the reality of the experience seriously without reducing it to neurochemistry."
---
...
- Griffiths, Roland R., Richards, William A., McCann, Una, and Jesse, Robert. "Psilocybin can occasion mystical-type experiences having substantial and sustained personal meaning and spiritual significance." *Psychopharmacology*, Vol. 187, No. 3, pp. 268-283, 2006. [PubMed](https://pubmed.ncbi.nlm.nih.gov/16826400/)
- Carhart-Harris, Robin L. et al. "Neural correlates of the psychedelic state as determined by fMRI studies with psilocybin." *PNAS*, Vol. 109, No. 6, 2012. [Link](https://www.pnas.org/doi/full/10.1073/pnas.1119598109)
- Carhart-Harris, Robin L. et al. "The entropic brain: a theory of conscious states informed by neuroimaging research with psychedelic drugs." *Frontiers in Human Neuroscience*, Vol. 8, Article 20, 2014. [Link](https://www.frontiersin.org/journals/human-neuroscience/articles/10.3389/fnhum.2014.00020/full)
...
- van Lommel, Pim, van Wees, Ruud, Meyers, Vincent, and Elfferich, Ingrid. "Near-death experience in survivors of cardiac arrest: a prospective study in the Netherlands." *The Lancet*, Vol. 358, No. 9298, pp. 2039-2045, 2001. [Link](https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(01)07100-8/fulltext)
