...
connections:
  ...
  - target: "jung"
    reason: "Carl Jung's doctrine of synchronicity — developed across thirty years of correspondence with the Nobel-laureate quantum physicist Wolfgang Pauli — proposes that mind and matter are not two separate substances but two aspects of a single underlying reality (the *unus mundus*) that occasionally manifests itself simultaneously in psychic and physical form, producing the experience of meaningful coincidence without any causal connection between the two events. This is not panpsychism in the strict philosophical sense, but it shares panpsychism's fundamental claim: that mind is not an epiphenomenon of matter, that consciousness and the physical world emerge from a common psychoid ground that is neither purely mental nor purely material, and that the materialist account of reality is missing the deeper layer from which both derive. The Jung-Pauli correspondence (published in 2001 as *Atom and Archetype: The Pauli/Jung Letters*) is one of the most remarkable interdisciplinary engagements with the mind-matter question in the twentieth century, and it produced conclusions that the contemporary panpsychism literature has rarely engaged with directly."
---
...
Vasubandhu's *Twenty Verses* (*Vimshatika*) presents a series of arguments against the reality of external objects — arguments that, remarkably, anticipate modern debates about [[consciousness]] and the [[hard-problem]]. If material objects existed independently of mind, Vasubandhu argued, we should be able to specify their smallest indivisible parts. But atoms, examined closely, dissolve into relations — just as Russell would argue fifteen centuries later. The supposedly solid, mind-independent world turns out to be a web of interdependent appearances with no independent foundation.
...
- Strawson, Galen. "Realistic Monism: Why Physicalism Entails Panpsychism." *Journal of Consciousness Studies*, Vol. 13, No. 10-11, pp. 3-31, 2006. [PhilPapers](https://philpapers.org/rec/STRRMW)
...
- Russell, Bertrand. *The Analysis of Matter*. Kegan Paul, Trench, Trubner & Co., 1927.
...
- Eddington, Arthur. *The Nature of the Physical World*. Macmillan, 1928.
