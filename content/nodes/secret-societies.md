...
connections:
  ...
  - target: "book-of-enoch"
    reason: "The Book of Enoch is the cleanest historical case available of how a major religious text can be excluded from the canonical scripture of one tradition by an institutional decision (the Council of Laodicea, ~363 CE) and continuously preserved as canonical scripture by another tradition (the Ethiopian Orthodox Tewahedo Church) in cultural and ecclesiastical isolation, only to be rediscovered fourteen centuries later by an independent investigator (the Scottish traveler James Bruce, 1773) who happened to wander into the territory where the suppressed text had been preserved all along. The Enoch case is the documented historical proof that suppressed knowledge does not necessarily disappear — it sometimes survives in marginal traditions whose marginality is the condition of their preservation, and it remains available for recovery if and when independent investigators happen to look in places that the institutional centers of knowledge are not looking. Every secret society claim about preserved hidden knowledge is, in this sense, a structural inheritance from the Enoch case: the proof that the pattern is real."
  - target: "bilderberg"
