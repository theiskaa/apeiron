...
export const READING_PATHS: ReadingPath[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "qanon", hook: "When conspiracy theories become a political movement — how 'trust the plan' captured millions", parents: ["epstein"] },
    ],
  },
  {
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "atlantis", hook: "Plato called it history, not myth — a civilization destroyed in a single day, on the date that exactly matches the end of the Younger Dryas", parents: ["megaliths"] },
