...
export const READING_PATHS: ReadingPath[] = [
  {
    ...
    nodes: [
      ...
      { id: "operation-northwoods", hook: "A signed Pentagon plan to stage attacks on Americans — declassified, real, and rejected by one man", parents: ["pearl-harbor-foreknowledge"] },
